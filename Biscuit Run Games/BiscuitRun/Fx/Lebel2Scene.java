...
class Lebel2Scene implements Runnable{
		...
		public void run()
		{
			double x=0,y=0,z=0,a=0,b=0,c=0,d=0,f=0,g=0,h=0,ob1=0,ob2=0;
			int count=0;
			while(count<3)
			{
				if(!plateFlag)
		...
		count=0;
		plateFlag=true;		
		backgroundImage= new Image("BiscuitRun/Fx/Image/level2BackgroundImage.jpg");
		...
		//-------------Obastacle------------------
		obstacle1= new Circle(430,450,15);
		obstacle1.setFill(Color.BLACK);
		obstacle2= new Circle(1000,450,15);
